    ...
    <center style="width: 100%; background-color: #E6ECF0;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); margin: 50px auto;">
            <tbody>
                ...
                <tr>
                    <td align="center" style="background-color: #444444; color: #ffffff; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;">
                        <h1 style="font-size: 24px; font-weight: 700; margin: 0;">Bem-vindo(a) ${nome}!</h1>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <b style="color: #a11010; font-weight: 600;">Maximus Trainning</b> 
                    <img src="LogoSemFgrandeICO.ico" width="20">
                     Por favor clique no botão abaixo para ativar sua conta:
                     </p>
                        
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin: 20px auto 0 auto;">
                            <tr>
                                <td align="center" style="border-radius: 5px; background-color: #c41d1d;">
